...
* Pull Request #2 (Conflict): Tình huống xung đột mã nguồn khi thay đổi nội dung trong file python tên main. Em đã tự xử lý conflicts thủ công trong tệp code ngay trên terminal và commit merge thành công thông qua Terminal.
